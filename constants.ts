...
export const PATIENTS: Patient[] = [
    {
        ...
        allergies: ['Penicillin', 'Aspirin', 'Latex', 'Local Anesthetic (ex. Lidocaine)', 'Sulfa drugs'],
        otherAllergies: 'Peanuts, Shellfish',
        medicalConditions: ['High Blood Pressure', 'Heart Disease', 'Diabetes', 'Bleeding Problems', 'Asthma', 'Kidney disease', 'Thyroid Problem'],
        ...
        registryAnswers: {
          ...
          'Do you use alcohol, cocaine or other dangerous drugs?': 'No',
          'Taking Blood Thinners? (Aspirin, Warfarin, etc.)': 'Yes',
          'Taking Bisphosphonates? (Fosamax, Zometa)': 'No',
