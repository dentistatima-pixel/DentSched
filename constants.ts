...
export const MOCK_STOCK: StockItem[] = [
    ...
    { id: 'cons_bur_diamond_round', name: 'Bur - Diamond Round (High Speed)', category: StockCategory.RESTORATIVE, quantity: 20, unitCost: 50.00, boxPrice: 250, unitsPerBox: 5, lowStockThreshold: 5, dispensingUnit: 'Piece', bulkUnit: 'Pack', conversionFactor: 5, location: 'Stock Room' },
    { id: 'cons_bur_fissure', name: 'Bur - Fissure (High Speed)', category: StockCategory.RESTORATIVE, quantity: 20, unitCost: 50.00, boxPrice: 250, unitsPerBox: 5, lowStockThreshold: 5, dispensingUnit: 'Piece', bulkUnit: 'Pack', conversionFactor: 5, location: 'Stock Room' },
...
export const DEFAULT_PROCEDURES: ProcedureItem[] = [
  ...
  { id: 'proc_denture_partial_1_3', name: '1-3 units partial denture', category: 'Prosthodontics', defaultPrice: 8000, defaultDurationMinutes: 60, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_partial_4_6', name: '4-6 units partial denture', category: 'Prosthodontics', defaultPrice: 12000, defaultDurationMinutes: 60, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_partial_7_10', name: '7-10 units partial denture', category: 'Prosthodontics', defaultPrice: 18000, defaultDurationMinutes: 90, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_flex_unilateral', name: 'Flexible denture unilateral', category: 'Prosthodontics', defaultPrice: 10000, defaultDurationMinutes: 45, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_flex_8_pontic', name: 'Flexible denture Up to 8 pontic', category: 'Prosthodontics', defaultPrice: 25000, defaultDurationMinutes: 90, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_thermosen_partial', name: 'Thermosen Partial', category: 'Prosthodontics', defaultPrice: 15000, defaultDurationMinutes: 60, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
  ...
  { id: 'proc_denture_thermosen_full', name: 'Thermosen Full', category: 'Prosthodontics', defaultPrice: 35000, defaultDurationMinutes: 120, requiresConsent: true, requiresImaging: true, triggersPostOpSequence: true, billOfMaterials: [
    { stockItemId: 'inst_mirror', quantity: 1 },
    { stockItemId: 'inst_imp_tray', quantity: 2 },
    { stockItemId: 'cons_bib', quantity: 1 },
    { stockItemId: 'cons_imp_alginate', quantity: 1 },
