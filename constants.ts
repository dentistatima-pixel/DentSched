...
export const DEFAULT_FIELD_SETTINGS: FieldSettings = {
  ...
  procedures: [
      ...
      { id: 'p2', name: 'Oral Prophylaxis', price: 1200, category: 'Preventive', allowedLicenseCategories: ['DENTIST', 'HYGIENIST'] },
      { id: 'p3', name: 'Restoration', price: 1500, category: 'Restorative', allowedLicenseCategories: ['DENTIST'], riskAllergies: ['Latex'], billOfMaterials: [ { stockItemId: 'stk_1', quantity: 1 }, { stockItemId: 'stk_2', quantity: 2 }, { stockItemId: 'stk_3', quantity: 1 }] },
      { id: 'p4', name: 'Extraction', price: 1000, category: 'Surgery', allowedLicenseCategories: ['DENTIST'], requiresConsent: true, riskAllergies: ['Latex', 'Penicillin'], riskDisclosures: ['Alveolar osteitis (dry socket)', 'Post-operative bleeding', 'Infection', 'Damage to adjacent teeth', 'Nerve paresthesia'], billOfMaterials: [ { stockItemId: 'stk_1', quantity: 2 }, { stockItemId: 'stk_2', quantity: 2 }] },
      { id: 'p5', name: 'Root Canal', price: 8000, category: 'Endodontics', allowedLicenseCategories: ['DENTIST'], requiresConsent: true, riskAllergies: ['Latex', 'Local Anesthetic'], riskDisclosures: ['Post-treatment sensitivity', 'Instrument separation', 'Re-infection', 'Tooth fracture', 'Sinus involvement'], billOfMaterials: [ { stockItemId: 'stk_7', quantity: 1 }, { stockItemId: 'stk_8', quantity: 4 }, { stockItemId: 'stk_1', quantity: 1 }] },
      { id: 'p6', name: 'Prosthodontics', price: 15000, category: 'Restorative', allowedLicenseCategories: ['DENTIST'] },
      { id: 'p7', name: 'Orthodontics', price: 50000, category: 'Orthodontics', allowedLicenseCategories: ['DENTIST'] },
      { id: 'p8', name: 'Surgery', price: 5000, category: 'Surgery', allowedLicenseCategories: ['DENTIST'], requiresConsent: true, riskAllergies: ['Latex', 'Penicillin', 'Local Anesthetic'], riskDisclosures: ['Jaw stiffness (trismus)', 'Nerve injury', 'Sinus perforation', 'Reaction to anesthetic'], billOfMaterials: [ { stockItemId: 'stk_1', quantity: 4 }, { stockItemId: 'stk_2', quantity: 2 }] },
      { id: 'p9', name: 'Whitening', price: 20000, category: 'Cosmetic', allowedLicenseCategories: ['DENTIST', 'HYGIENIST'] },
      { id: 'p10', name: 'Denture Adjustments', price: 500, category: 'Prosthodontics', allowedLicenseCategories: ['DENTIST', 'TECHNOLOGIST'] },
      { id: 'p11', name: 'Sealant', price: 1500, category: 'Pediatric', allowedLicenseCategories: ['DENTIST', 'HYGIENIST'] },
      { id: 'p12', name: 'Exam', price: 0, category: 'General', allowedLicenseCategories: ['DENTIST', 'HYGIENIST'] },
      { id: 'p13', name: 'Crown', price: 12000, category: 'Prosthodontics', allowedLicenseCategories: ['DENTIST'], riskAllergies: ['Latex'] },
      { id: 'p14', name: 'Missing', price: 0, category: 'General', allowedLicenseCategories: ['DENTIST', 'HYGIENIST', 'TECHNOLOGIST'] },
      { id: 'p15', name: 'Communication Log', price: 0, category: 'General', allowedLicenseCategories: ['DENTIST', 'HYGIENIST', 'TECHNOLOGIST'] }
  ], 
