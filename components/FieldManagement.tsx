...
const FieldManagement: React.FC<FieldManagementProps> = ({ settings, onUpdateSettings, staff = [], onUpdateStaff, auditLog, patients = [], onPurgePatient, onExportAuditLog, incidents = [], wasteLogs = [], assetLogs = [] }) => {
    ...
    const menuStructure = [
        ...
        { group: 'Legal & Compliance', icon: Shield, items: [
            ...
            { key: 'wasteLogs', label: 'Bio-Medical Waste Log', icon: Droplet }, // NEW
            { key: 'assetLogs', label: 'Asset Maintenance Registry', icon: Wrench }, // NEW
    ...
    const renderCurrentCategory = () => {
        switch(activeCategory) {
            ...
            case 'wasteLogs': return renderWasteLogs(); // NEW
            case 'assetLogs': return renderAssetLogs(); // NEW
