...
import { Patient, FieldSettings, AuthorityLevel, RegistrationField, FamilyGroup } from '../types';
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-5">
                ...
                >
                    ...
                    {(fieldSettings.familyGroups || []).map((group: FamilyGroup) => <option key={group.id} value={group.id}>{group.familyName}</option>)}
                </select>
            </div>
        </div>
