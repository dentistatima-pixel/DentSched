      ...
      <header className="flex items-center gap-4 bg-white p-3 rounded-2xl border border-slate-100 shadow-sm">
            ...
            <div className="flex gap-2 shrink-0">
                 <button onClick={() => onBookAppointment()} className="h-11 px-4 bg-lilac-100 hover:bg-lilac-200 text-lilac-700 rounded-xl flex items-center justify-center gap-2 transition-colors" title="Book Appointment">
                    <CalendarPlus size={20} /> <span className="hidden md:inline font-bold text-sm">Book Appointment</span>
                </button>
      ...
      <div className="space-y-6">
                  ...
                  {todaysAppointments.length === 0 ? (
                      ...
                      todaysAppointments.map(apt => {
                          ...
                          const getRowStyle = (s: string) => {
                              switch(s) {
                                  case AppointmentStatus.ARRIVED: return 'bg-orange-50/60 border-l-4 border-l-orange-400 hover:bg-orange-100/50';
                                  case AppointmentStatus.SEATED: return 'bg-blue-50/60 border-l-4 border-l-blue-400 hover:bg-blue-100/50';
                                  case AppointmentStatus.TREATING: return 'bg-lilac-50/60 border-l-4 border-l-lilac-400 hover:bg-lilac-100/50';
                                  case AppointmentStatus.COMPLETED: return 'bg-emerald-50/40 border-l-4 border-l-emerald-400 opacity-70 hover:opacity-100';
                                  default: return 'bg-white border-l-4 border-l-transparent hover:bg-slate-50';
                              }
                          };
          ...
          <div className="bg-teal-900 rounded-2xl shadow-lg border border-teal-800 p-4 text-white flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      ...
                      <p className="text-teal-300 text-xs">Get A Head Start On Tray Setups And Sterilization.</p>
                  </div>
              </div>
              <div className="flex gap-4 md:gap-8">
                  ...
                  <div className="text-center">
                      ...
                      <div className="text-[10px] text-teal-300 uppercase font-bold tracking-wider">Major Procedures</div>
                  </div>
                  <div className="w-px bg-teal-800"></div>
                  <div className="text-center">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col h-[350px]">
                <div className="px-6 py-4 border-b border-slate-50 bg-slate-50/50">
                    <h3 className="font-bold text-slate-800 flex items-center gap-2">
                        <Repeat className="text-purple-500" size={18} /> Clinic Opportunities
                    </h3>
                </div>
          ...
          <div className="bg-yellow-50 rounded-2xl shadow-sm border border-yellow-200 overflow-hidden flex flex-col h-[350px]">
                <div className="px-4 py-3 border-b border-yellow-100 bg-yellow-100/50 flex justify-between items-center shrink-0">
                    ...
                    <span className="text-[10px] text-yellow-600 font-bold uppercase">{sortedTasks.filter(t => !t.isCompleted).length} Active Tasks</span>
                </div>
